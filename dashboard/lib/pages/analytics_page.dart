...
class _AnalyticsPageState extends State<AnalyticsPage> {
  ...
  static const List<AnalyticsMetricConfig> analyticsMetrics = [
    AnalyticsMetricConfig(
      ...
      description: 'Deviation from normal latency patterns',
      insight:
          'Positive values indicate higher than expected latency. Spikes may signal performance degradation or unusual traffic patterns.',
    ),
    AnalyticsMetricConfig(
      key: 'latency_slope',
      label: 'Latency Slope',
  ...
  void initState() {
    super.initState();
    _selectedMetricKey = analyticsMetrics.first.key; // Default to first metric
    _loadCsv();
  }
